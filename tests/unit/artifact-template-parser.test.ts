...
describe('parseArtifactTemplate', () => {
    it('提取模板名称（从路径）', () => {
        ...
        const result = parseArtifactTemplate(content, '/some/dir/task-stream-a-template.md');
    ...
    it('提取锚点名（显式 {{TASK_STREAM}}）', () => {
        ...
        const result = parseArtifactTemplate(content, '/tmp/test-template.md');
    ...
    it('返回完整 ParsedArtifactTemplate 结构', () => {
        ...
        const result = parseArtifactTemplate(content, '/home/user/report-template.md');
